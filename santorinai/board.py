...
class Board:
    ...
    def is_pawn_on_position(self, position):
        """
    ...
    def get_possible_building_positions(self, pawn):
        """
    ...
    def play_move(self, move_vector, build_vector):
        """
    ...
    def is_vector_valid(self, vector):
        """
